...
export default function AboutPreview() {
  return (
    <section className="relative overflow-hidden bg-[#030812] text-white px-4 py-16 sm:py-24 sm:px-6 md:px-10">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-16 md:gap-12 lg:gap-16 md:grid-cols-2 items-center">
        ...
        >
          <div className="absolute -inset-2 md:-inset-4 rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-tr from-teal-500/10 via-transparent to-orange-500/10 blur-xl md:blur-2xl opacity-50" />
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-50px" }}
          transition={{ duration: 0.8 }}
          className="relative text-center md:text-left mt-8 md:mt-0"
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[10px] uppercase tracking-[0.3em] text-teal-400 mb-4 md:mb-6">
            <Sparkles size={12} />
            The Partnership
          </div>
