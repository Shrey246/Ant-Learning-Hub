...
export default function Footer() {
  return (
    // Removed mt-24 to eliminate the gap, updated background color to match
    <footer className="relative overflow-hidden bg-[#030812] text-white">
      ...
      {/* PREMIUM TOP BORDER (The glass edge) */}
      <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-white/10 to-transparent" />

      <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 md:px-10">
        ...
        <div className="grid gap-16 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-5 text-gray-400 max-w-sm leading-relaxed font-light">
            ...
            <Link
              href="/Contact"
              className="group mt-8 inline-flex items-center gap-2 text-sm font-semibold text-teal-400 transition-colors hover:text-teal-300"
            >
              Start your journey 
          ...
          {/* LINKS */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-widest text-gray-300 mb-6">
              Explore
            </h3>
        ...
        {/* BOTTOM BAR */}
        <div className="mt-20 border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
