    ...
    <>
      ...
      <main className="relative min-h-screen overflow-hidden bg-[#030812] text-white pt-12 md:pt-28">
        ...
        <section
          ...
          className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 md:px-10"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 xl:gap-6">
            {programGroups.map((program, index) => {
              ...
              return (
                ...
                >
                  {/* FOCUSED LIGHT LEAK */}
                  <div aria-hidden="true" className={`absolute top-0 left-0 w-48 h-48 ${program.glow} blur-[80px] rounded-full pointer-events-none transition-opacity duration-700 opacity-40 group-hover:opacity-100`} />
                  ...
                  <div className="mt-6 relative z-10">
                    ...
                    >
                      Enquire Now
                      <ArrowRight size={20} aria-hidden="true" className="ml-2 transition-transform group-hover/btn:translate-x-1" />
                    </button>
                  </div>
                </motion.article>
              );
          ...
          >
            ...
            >
              ...
              <div className="mb-5">
                ...
                <h2 id="modal-heading" className="text-2xl md:text-3xl font-bold leading-tight">
                  Enquire for{" "}
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                ...
                {/* PROFESSION */}
                <div className="relative">
                  <label htmlFor="enquiry-profession" className="sr-only">Profession (optional)</label>
                  <input
                    id="enquiry-profession"
                    name="profession"
